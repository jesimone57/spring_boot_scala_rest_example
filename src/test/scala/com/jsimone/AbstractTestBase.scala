...
abstract class AbstractTestBase {
    protected val APPLICATION_JSON = "[" + MediaType.APPLICATION_JSON_VALUE + "]"
    ...
    protected def verifySuccessResponse(responseEntity: ResponseEntity[String],
                                        expectedStatus: HttpStatus,
                                        expectedMediaType: MediaType,
                                        expectedResponseBody: String): Unit = {
